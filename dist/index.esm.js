...
var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/icicb/logo.png" })));
};
...
var Icon$I = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/icicb/9.png" })));
};
...
var DefaultSeparator = React.createElement(Icon$V, { color: "currentColor", width: "24px" });
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$K, { color: "primary", ml: "4px" })));
};
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/icicb/9.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "100", height: "26", href: isDark ? '/images/icicb/LogoTextNewDark.png' : '/images/icicb/LogoTextNewDark.png' })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$N, { className: "mobile-icon" }),
        React.createElement(Logo$1, { className: "desktop-icon", isDark: isDark, width: "400px" })));
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        ...
        React.createElement(SettingsEntry, null,
            React.createElement(Button, { variant: "text", startIcon: React.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
                React.createElement(Text, { color: "textSubtle" }, "EN")))));
};
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$Q, { width: "20px", color: "primary", ml: "4px" }),
...
export { Icon$17 as AddIcon, Alert, Icon$16 as ArrowBackIcon, Icon$15 as ArrowDownIcon, Icon$14 as ArrowDropDownIcon, Icon$13 as ArrowDropUpIcon, Icon$12 as ArrowForwardIcon, Icon$11 as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$10 as BinanceIcon, Icon$19 as BlockIcon, Breadcrumbs, Icon$$ as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$Z as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$_ as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$1b as CheckmarkCircleIcon, Icon$Y as CheckmarkIcon, Icon$X as ChevronDownIcon, Icon$W as ChevronLeftIcon, Icon$V as ChevronRightIcon, Icon$U as ChevronUpIcon, Icon$T as CloseIcon, Icon$S as CogIcon, Icon$R as CommunityIcon, Icon$Q as CopyIcon, CopyToClipboard, Dropdown, Icon$1a as ErrorIcon, Flex, Icon$H as GooseRoundIcon, Heading, Icon$P as HelpIcon, IconButton, Image, Icon$18 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$O as ListViewIcon, Icon$N as LogoIcon, Icon$M as LogoRoundIcon, Menu, Icon$L as MinusIcon, Modal, ModalProvider, Icon$K as OpenNewIcon, Icon$I as PancakeRoundIcon, Icon$J as PancakesIcon, Icon$G as PrizeIcon, Progress, Icon$D as ProgressBunny, Radio, Icon$F as RemoveIcon, ResetCSS, Icon$z as SearchIcon, Skeleton, Spinner, Svg, Icon$y as SwapVertIcon, Icon$x as SyncAltIcon, Tag, Text, Icon$B as Ticket, Icon$A as TicketRound, ToastContainer, Toggle, Icon$E as VerifiedIcon, Icon$w as WarningIcon, Icon$C as Won, variants as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
