...
var LinkExternal = function (_a) {
    ...
    return (React__default["default"].createElement(Link, __assign({ external: true }, props),
        children,
        React__default["default"].createElement(Icon$I, { color: "white", ml: "4px" })));
};
    ...
    return (React__default["default"].createElement(StyledModal, null,
        React__default["default"].createElement(ModalHeader, null,
            React__default["default"].createElement(ModalTitle, null,
                onBack && (React__default["default"].createElement(IconButton, { variant: "tertiary", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default["default"].createElement(Icon$14, { color: "third" }))),
                React__default["default"].createElement(Heading, null, title)),
            !hideCloseButton && (React__default["default"].createElement(IconButton, { variant: "tertiary", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default["default"].createElement(Icon$R, { color: "thirdBright" })))),
...
var Logo$1 = function (_a) {
    ...
    return (React__default["default"].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default["default"].createElement("image", { width: "100", height: "26", href: isDark ? '/images/icicb/icicb_logo.png' : '/images/icicb/icicb_logo.png' })));
};
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default["default"].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default["default"].createElement(Icon$O, { width: "20px", color: "white", ml: "4px" }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#f4f7fa", invertedContrast: "black", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#113049", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#bddaf8", background: "url(/images/background.png)", backgroundDisabled: "#113049", contrast: "#FFFFFF", invertedContrast: "#f4f7fa", input: "#090805", primaryDark: "#0098A1", tertiary: "#090805", text: "#e4e8ea", textDisabled: "#666171", textSubtle: "#b8b8b8", borderColor: "#D0B49F", card: "#090805", gradients: {
...
var light$5 = (_a = {},
    ...
    _a);
var dark$5 = (_b = {},
    _b[PRIMARY] = __assign(__assign({}, light$5.primary), { background: darkColors.third, backgroundActive: darkColors.thirdDark, backgroundHover: darkColors.thirdBright, borderColorHover: "currentColor", boxShadow: "inset 0px -1px 0px rgba(14, 14, 44, 0.4)", boxShadowActive: "inset 0px -1px 0px rgba(14, 14, 44, 0.4)", color: darkColors.card }),
